  ...
  if (req.method === 'GET') {
    try {
      ...
      return res.status(200).json({
        ...
        tasks: data.map(task => ({
          id: task.id,
          title: task.task_name,           // ← Map to 'title'
          status: task.task_status,        // ← Map to 'status'
          priority: task.priority,
          due_date: task.due_date,         // ← Keep as 'due_date'
          assigned_to: task.assigned_to,   // ← Keep as 'assigned_to'
          notes: task.notes,
